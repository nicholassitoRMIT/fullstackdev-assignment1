        ...
        <div>
            ...
            <div className="row1">
                <div className="imgRow1">
                    ...
                    <h2><Link to="/movies" className="movieTitle">The Climber</Link></h2>
                    <p>12:00 - 13:30</p>
                    <p>14:00 - 15:30</p>
                </div>
                ...
                <div className="imgRow1">
                    ...
                    <h2><Link to="/movies" className="movieTitle">Crossroads</Link></h2>
                    <p>12:30 - 14:00</p>
                    <p>17:00 - 18:30</p>
                </div>
                ...
                <div className="imgRow1">
                    ...
                    <h2><Link to="/movies" className="movieTitle">Dance Dance Revolution</Link></h2>
                    <p>11:00 - 13:00</p>
                    <p>16:00 - 18:00</p>
                </div>
            </div>
            ...
            <div className="row2">
                <div className="imgRow2">
                    ...
                    <h2><Link to="/movies" className="movieTitle">The Skiier</Link></h2>
                    <p>10:30 - 12:00</p>
                    <p>12:30 - 14:00</p>
                </div>
                ...
                <div className="imgRow2">
                    ...
                    <h2><Link to="/movies" className="movieTitle">Champion's Run</Link></h2>
                    <p>11:00 - 13:00</p>
                    <p>15:00 - 17:00</p>
                </div>
                ...
                <div className="imgRow2">
                    ...
                    <h2><Link to="/movies" className="movieTitle">Kickout</Link></h2>
                    <p>11:00 - 12:30</p>
                    <p>13:30 - 15:00</p>
                </div>
            </div>
